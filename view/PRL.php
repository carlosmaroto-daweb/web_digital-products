            ...
            <div class="home-content text-start">
                <div class="row">
                    <div class="col-md-9 col-lg-7">
                        <h1 class="hs-line-3 mb-30 mb-xs-20 wow fadeInUpShort" data-wow-delay=".1s">Prevención riesgos laborales</h1>

                        <h2 class="hs-line-5 mb-60 mb-xs-40 wow fadeInUpShort" data-wow-delay=".2s">
                            We bring innovation ideas into
                            <span class="sr-only">reality</span>
                            <span data-period="2800" data-type='[ "reality", "the world", "design"]' class="typewrite" aria-hidden="true"><span class="wrap"></span></span>
                        </h2>

                        <div class="local-scroll wow fadeInUpShort" data-wow-delay=".3s">
                            <a href="#about" class="btn btn-mod btn-w btn-medium btn-round me-md-1">Saber más</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="page-section bg-dark light-content">
        <div class="container relative">
            ...
            <div class="text-center mb-80 mb-sm-50">
                <h2 class="section-title">Minimal Tabs</h2>
            </div>
