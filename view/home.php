                    ...
                    <section class="home-section bg-scroll bg-dark-alfa-30 light-content" data-background="view/assets/img/full-width-images/section-bg-19.jpg">
                        <div class="container fixed-height-medium d-flex align-items-center">
                            ...
                            <div class="home-content">
                                <h1 class="hs-line-4 mb-30 mb-xs-10 owl-animate-1">Awards Winning Creative Studio</h1>
                                <h2 class="hs-line-7 mb-60 mb-xs-20 owl-animate-2 owl-delay-450">We turn ideas into reality</h2>
                                <div class="local-scroll mb-20 mb-xs-0 owl-animate-3 owl-delay-700">
                                    ...
                                    <a href="pages-contact-1-dark.html" class="btn btn-mod btn-w btn-medium btn-round mx-md-1">Start Project</a>
                                </div>
                            </div>
                            <!-- End Hero Content -->
                    ...
                    <div class="full-wrapper relative">
                        ...
                        <ul class="works-grid work-grid-3 work-grid-gut clearfix hide-titles" id="work-grid">
                            ...
                            <li class="work-item mix photography">
                                <a href="view/assets/img/portfolio/full-project-1.jpg" class="work-lightbox-link mfp-image">
                                    <div class="work-img">
                                        <div class="work-img-bg wow-p scalexIn"></div>
                                        <img src="view/assets/img/portfolio/projects-1.jpg" alt="Work Description" class="wow-p fadeIn" data-wow-delay="1s" />
                                    </div>
                            ...
                            <li class="work-item mix branding design">
                                <a href="portfolio-single-1-dark.html" class="work-ext-link">
                                    <div class="work-img">
                                        <div class="work-img-bg wow-p scalexIn"></div>
                                        <img src="view/assets/img/portfolio/projects-2.jpg" alt="Work Description" class="wow-p fadeIn" data-wow-delay="1s" />
                                    </div>
                                    <div class="work-intro">
                            ...
                            <li class="work-item mix branding">
                                <a href="portfolio-single-1-dark.html" class="work-ext-link">
                                    <div class="work-img">
                                        <div class="work-img-bg wow-p scalexIn"></div>
                                        <img src="view/assets/img/portfolio/projects-3.jpg" alt="Work Description" class="wow-p fadeIn" data-wow-delay="1s" />
                                    </div>
                                    <div class="work-intro">
                            ...
                            <li class="work-item mix design photography">
                                <a href="portfolio-single-1-dark.html" class="work-ext-link">
                                    <div class="work-img">
                                        <div class="work-img-bg wow-p scalexIn"></div>
                                        <img src="view/assets/img/portfolio/projects-4.jpg" alt="Work Description" class="wow-p fadeIn" data-wow-delay="1s" />
                                    </div>
                                    <div class="work-intro">
                            ...
                            <li class="work-item mix design">
                                <a href="portfolio-single-1-dark.html" class="work-ext-link">
                                    <div class="work-img">
                                        <div class="work-img-bg wow-p scalexIn"></div>
                                        <img src="view/assets/img/portfolio/projects-5.jpg" alt="Work Description" class="wow-p fadeIn" data-wow-delay="1s" />
                                    </div>
                                    <div class="work-intro">
                            ...
                            <li class="work-item mix design branding">
                                <a href="view/assets/img/portfolio/full-project-6.jpg" class="work-lightbox-link mfp-image">
                                    <div class="work-img">
                                        <div class="work-img-bg wow-p scalexIn"></div>
                                        <img src="view/assets/img/portfolio/projects-6.jpg" alt="Work Description" class="wow-p fadeIn" data-wow-delay="1s" />
                                    </div>
                                    <div class="work-intro">
                    ...
                    <div class="container relative">
                        <div class="row">
                            ...
                            <div class="col-lg-5 wow fadeInUpShort" data-wow-duration="1.2s" data-wow-offset="255">
                                ...
                                <div class="local-scroll">
                                    <a href="pages-contact-1-dark.html" class="btn btn-mod btn-w btn-large btn-round">Start Project</a>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3 col-lg-3 mb-md-50">
                                <div class="post-prev-img">
                                    <a href="shop-single-dark.html" tabindex="-1"><img src="view/assets/img/shop/shop-prev-1.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s" /></a>
                            ...
                            <div class="col-sm-6 col-md-3 col-lg-3 mb-md-50">
                                <div class="post-prev-img">
                                    <a href="shop-single-dark.html" tabindex="-1"><img src="view/assets/img/shop/shop-prev-2.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s" /></a>
                                </div>
                                <div class="post-prev-title text-center mb-10">
                            ...
                            <div class="col-sm-6 col-md-3 col-lg-3 mb-md-50">
                                <div class="post-prev-img">
                                    <a href="shop-single-dark.html" tabindex="-1"><img src="view/assets/img/shop/shop-prev-3.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s" /></a>
                                </div>
                                <div class="post-prev-title text-center mb-10">
                            ...
                            <div class="col-sm-6 col-md-3 col-lg-3 mb-md-50">
                                <div class="post-prev-img">
                                    <a href="shop-single-dark.html" tabindex="-1"><img src="view/assets/img/shop/shop-prev-4.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s" /></a>
                                </div>
                                <div class="post-prev-title text-center mb-10">
                    ...
                    <div class="container relative">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-4 mb-md-50">
                                ...
                                <div class="post-prev-img">
                                    <a href="blog-single-sidebar-right-dark.html" tabindex="-1"><img src="view/assets/img/blog/post-prev-1.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s" /></a>
                                </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-4 mb-md-50">
                                ...
                                <div class="post-prev-img">
                                    <a href="blog-single-sidebar-right-dark.html" tabindex="-1"><img src="view/assets/img/blog/post-prev-2.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s" /></a>
                                </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-4 mb-md-50">
                                ...
                                <div class="post-prev-img">
                                    <a href="blog-single-sidebar-right-dark.html" tabindex="-1"><img src="view/assets/img/blog/post-prev-3.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s" /></a>
                                </div>
